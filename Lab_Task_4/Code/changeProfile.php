...
$sql = "UPDATE labtask4 SET name='".$name."',email='".$email."',gender='".$gender."',dateofbirth='".$dob."' WHERE username='".$_SESSION['username']."' AND password='".$_SESSION['password']."'";
...
$sql = "SELECT * FROM labtask4 WHERE username='".$_SESSION['username']."' AND password='".$_SESSION['password']."'";
